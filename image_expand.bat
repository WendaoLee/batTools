...
:do expand
for %%I IN (*.jpg) Do COPY %%I /B + sourcedata %binpath%%%I_new.jpg&COPY %%I %sourcepath%%%I_source.jpg
for %%I IN (*.jpeg) Do COPY %%I /B + sourcedata %binpath%%%I_new.jpeg&COPY *.jpeg %sourcepath%%%I_source.jpeg
for %%I IN (*.png) Do COPY %%I /B + sourcedata %binpath%%%I_new.png&COPY *.jpeg %sourcepath%%%I_source.png
